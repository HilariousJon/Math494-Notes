...
\begin{note}
	It is clear that \( \FF_p(t) \) is not a finite field, this means that for a field with
	characteristic \( p \) it is not necessarily finite. However, if characteristic is \( 0 \) the
	field is infinite, by the following \( \QQ \hookrightarrow \KK \).
\end{note}
...
\begin{definition}[\textbf{Finite Field Extension}]
	\( \qo{L}{\KK} \) is \underline{finite field extension} if \( [L:K] < \infty \).
\end{definition}
	...
	\item Case 2: \( \ker(\vp) \ne \{0\} \), since \( \KK[x] \) is a PID, then \( \ker(\vp) = (f) \)
	      ...
	      \begin{notation}
		      ...
		      \begin{note}
			      ...
			      \[
				      K[A] = \{f(a_1,\ldots, a_n) \; | \; f\in K[x_1,\ldots, x_n], \; a_i \in A\}
			      \]
		      \end{note}
	      \end{notation}

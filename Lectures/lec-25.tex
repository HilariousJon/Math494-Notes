...
\begin{conclusion}
	...
	\]
\end{conclusion}
\underline{Bace to our setting}: Let \( \KK \) be a field, and \( V \) be vector space over \( \KK \), with
...
\begin{proposition}
	...
	of \( T \) w.r.t. this basis. Then we have \textcolor{red}{a short exact sequence} of \( \KK[x] \)-module as
	follows:
	\[
	...
	\begin{enumerate}
		\item \( \psi(e_i) = u_i \) for \( 1\leq i \leq n \) where \( e_1,\ldots, e_n \) be standard
		      basis of \( \KK[x]^n \).
		\item The matrix of \( \vp \) w.r.t. the standard basis is \( x\cdot I_n - A \).
	\end{enumerate}
\end{proposition}
...
\begin{proof}
	...
	\[
		\ker(\psi) = \im (\vp)
	\]
	we need to show \( \psi \) is isomorphism. We already know that \( \psi \) is surjective with \(
	...
	\[
		x^j \overline{e_i} \in \langle \overline{e_1}, \ldots, \overline{e_i} \in \sum_{l=1}^n \KK
		\overline{e_l}
	\]
	...
	\[
		\begin{aligned}
			...
			\KK \overline{e_l}                                                                                                             \\
			                                                           & \text{where the last inclusion given by induction on }j
		\end{aligned}
	\]

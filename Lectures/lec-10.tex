...
\begin{remark}
	Let \( R \) be a ring.
	\begin{enumerate}
		\item If \( I \) is a two-sided ideal in \( R \) and \( R \) is left (right) Noetherian, then \( qo{R}{I} \) is left (right) Noetherian.
		\item If \( R \) is commutative and Noetherian, then for every multiplicative system \( S \subseteq R \), the ring fractions \( S^{-1} R \) is Noetherian.
	\end{enumerate}
\end{remark}
...
\begin{corollary}
	If \( R \) be any commutativr ring such that \( R[x] \) is a PID, then \( R \) is a field.
\end{corollary}

...
\begin{proposition}
	If \( K \hookrightarrow L \) is a finite extension, then it is of finite type.
\end{proposition}

\begin{eg}
	See that \( K(x) = K[x] \) is of finite type, but not algebraic.
\end{eg}
...
\begin{eg}
	...
	\begin{enumerate}
		...
		\item Let \( \QQ \hookrightarrow \CC \). Now we have
		      \[
			      \overline{\QQ} = \{a\in \CC \; | \; a \text{ algebraic over } \QQ\} \subsetneq \CC
		      \]
		      ...
		      ``most'' element of \( \CC \) \textbf{are not in} \( \overline{\QQ} \).

		      \begin{note}
			      \( \overline{\QQ} \) is again algebraically closed, by that if \( f \in \overline{\QQ}[x] \implies f  \)
		...
		\item Cyclotomic extensions of \( \QQ \): if \( n \in \ZZ_{>0} \) and \( \omega \in \CC \) be
		      ...
		      \]
		      is algerbaic and hence finite since \( \omega^n - 1 = 0 \) and of course not necessarily the minimal polynomial.
	\end{enumerate}
\end{eg}
...
\begin{definition}[\textbf{Galois Group}]
	...
	\]
	\textcolor{blue}{i.e. \( \sigma \) automorphism and \( \sigma(u) = u \; \forall \; u \in K \)}, with the group

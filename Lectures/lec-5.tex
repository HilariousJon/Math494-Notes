...
\begin{definition}[\textbf{Multiplication System}]
  Fix \( R \) be commutative ring, \( S\subseteq R \) be a \underline{multiplication system} if:
  \begin{enumerate}
    \item \( 1\in S \).
...
\begin{definition}
  ...
  Note that \( 0 \) is not necessarily in \( S \).
\end{definition}

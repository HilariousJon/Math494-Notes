			      ...
			      \item \textbf{Case 2}: Let \( f\in R[x] \backslash \{0\} \), \( \deg(f) \geq 1 \)
			            ...
			            \begin{itemize}
				            ...
				            \item Say \( f = gh \) where \( g,h \in R[x] \). Since \( f \) is irreducible in
				                  ...
				                  primitive, and that means \( g \) will divided the gcd of the coefficients of \(
				                  f\) by the definition of primitivity and thus also being a gcd, this means that \( g \) will be a unit in \( R \), hence unit in \( R[x] \).
			            \end{itemize}
		      \end{enumerate}
	\end{itemize}
\end{proof}
...
\begin{proof}
	...
	\begin{itemize}
		\item Existence of irreducible decomposition: Let \( f \in R[x] \) with \( f \ne 0 \) and \( f \ne  \)
		      ...
		      R\) and \( f' \) primitive in \( R[x] \). Since \( \KK[x]\) \hl{is a UFD}, then if \( \deg(f) > 0 \)
		      can write:
		      \[
			      \begin{aligned}
		      ...
		      \[
			      \begin{aligned}
				      c(f) & = \pi_1 \cdots \pi_s                                    \\
				           & \text{where } \pi_i \in R \text{ are irreducible, hence
		...
		\item Uniqueness of irreducible decomposition: We saw that it is enough to show that \( f \) is
		      ...
		      \begin{itemize}
			      \item \textbf{Case 1}: Let \( f \in R \) be irreducible in \( R \) and \( R \) being a
			            ...
			            is prime ideal since \( \qo{R[x]}{R[x]f} \) is a domain by the fact
			            \[
				            \qo{R[x]}{R[x]f} \cong \qo{R}{(f)}[x]
			            \]
			            thus \( f \) is prime
			            element in \( R[x] \).

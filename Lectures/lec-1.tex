...
\begin{remark}
  In homework, we shall see if \( f: R\to S \), \( g: S\to T \) are ring homomorphisms, then \( g\circ f: R\to T \) is again a ring homomorphisms. In particular we have a category \underline{Rings}:
  \begin{itemize}
    \item Objects: rings.

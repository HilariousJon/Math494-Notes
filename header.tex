...
\usepackage{textcomp}
\usepackage{soul} % for highlight syntax
...
\declaretheoremstyle[
	headfont=\bfseries\sffamily\color{Plum!70!black}, bodyfont=\normalfont,
	mdframed={
			linewidth=2pt,
			rightline=false, topline=false, bottomline=false,
...
\declaretheoremstyle[
	headfont=\bfseries\sffamily\color{Mahogany!70!black}, bodyfont=\normalfont,
	mdframed={
			linewidth=2pt,
			rightline=false, topline=false, bottomline=false,
			linecolor=Mahogany, backgroundcolor=Mahogany!5,
			nobreak=false
		}
]{thmmahoganybox}
...
\declaretheorem[style=thmorangebox, name=Lemma, numberwithin=section]{lemma}
\declaretheorem[style=thmplumbox, name=Proposition, numberwithin=section]{proposition}
\declaretheorem[style=thmmahoganybox, name=Corollary, numberwithin=section]{corollary}
...
\declaretheorem[style=conclredbox, name=Conclusion, numberwithin=section]{conclusion}
\declaretheorem[style=conjpurplebox, name=Question, numberwithin=section]{question}
...
\declaretheorem[style=thmredbox, name=Fact, numberwithin=section]{fact}
...
\renewenvironment{proof}[1][\proofname]{\par
	...
	\trivlist
	\item[\hskip\labelsep
	            \color{CadetBlue!80!black}\sffamily\bfseries
	            #1\@addpunct{.}]\ignorespaces
	\begin{mdframed}[linewidth=2pt,rightline=false, topline=false, bottomline=false,linecolor=CadetBlue, backgroundcolor=CadetBlue!2]
		}{%
		\popQED\endtrivlist\@endpefalse
	\end{mdframed}
}
...
\declaretheorem[style=thmgreen3box, numbered=no, name=Idea]{idea}
...
\declaretheorem[style=notgraybox, numbered=no, name=Parenthesis]{parenthesis}
